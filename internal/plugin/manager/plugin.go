...
import (
	...
	pbgrpc "github.com/GoogleCloudPlatform/google-guest-agent/internal/plugin/proto/grpc/google_guest_agent/plugin"
...
func (p *Plugin) PluginService() pbgrpc.GuestAgentPluginClient {
	return pbgrpc.NewGuestAgentPluginClient(p.client)
}

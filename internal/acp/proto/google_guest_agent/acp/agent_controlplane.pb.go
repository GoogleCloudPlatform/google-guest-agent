...
const (
	...
	// The agent supports sending telemetry over unary RPC.
	AgentInfo_SEND_UNARY_TELEMETRY AgentInfo_AgentCapability = 6
)
...
const file_agent_controlplane_proto_rawDesc = "" +
	...
	"\fGetAgentInfo\"\xfe\x02\n" +
	"\tAgentInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12\"\n" +
	"\farchitecture\x18\x03 \x01(\tR\farchitecture\x12\\\n" +
	"\x12agent_capabilities\x18\x04 \x03(\x0e2-.agent_controlplane.AgentInfo.AgentCapabilityR\x11agentCapabilities\"\xc0\x01\n" +
	...
	"\x13APPLY_PLUGIN_CONFIG\x10\x05\x12\x18\n" +
	"\x14SEND_UNARY_TELEMETRY\x10\x06\"\v\n" +
	"\tGetOSInfo\"\xe4\x01\n" +
	"\x06OSInfo\x12\x12\n" +

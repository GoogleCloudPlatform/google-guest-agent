...
const file_plugin_comm_proto_rawDesc = "" +
	"\n" +
	"\x11plugin_comm.proto\x12\vplugin_comm\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xfd\x01\n" +
	"\fStartRequest\x128\n" +
	"\x06config\x18\x01 \x01(\v2 .plugin_comm.StartRequest.ConfigR\x06config\x12%\n" +
	"\rstring_config\x18\x02 \x01(\tH\x00R\fstringConfig\x12>\n" +
	"\rstruct_config\x18\x03 \x01(\v2\x17.google.protobuf.StructH\x00R\fstructConfig\x1a:\n" +
	"\x06Config\x120\n" +
	"\x14state_directory_path\x18\x01 \x01(\tR\x12stateDirectoryPathB\x10\n" +
	"\x0eservice_config\"\x0f\n" +
	"\rStartResponse\"\x8d\x01\n" +
	"\fApplyRequest\x12%\n" +
	"\rstring_config\x18\x02 \x01(\tH\x00R\fstringConfig\x12>\n" +
	"\rstruct_config\x18\x03 \x01(\v2\x17.google.protobuf.StructH\x00R\fstructConfigB\x10\n" +
	"\x0eservice_configJ\x04\b\x01\x10\x02\"\x0f\n" +
	"\rApplyResponse\"4\n" +
	...
	"\x04Stop\x12\x18.plugin_comm.StopRequest\x1a\x19.plugin_comm.StopResponse\"\x00\x12A\n" +
	"\tGetStatus\x12\x1d.plugin_comm.GetStatusRequest\x1a\x13.plugin_comm.Status\"\x00\x12@\n" +
	"\x05Apply\x12\x19.plugin_comm.ApplyRequest\x1a\x1a.plugin_comm.ApplyResponse\"\x00B\x0eZ\f/plugin_commb\x06proto3"

...
func (m *ApplyRequest) GetServiceConfig() isApplyRequest_ServiceConfig {
	if m != nil {
		return m.ServiceConfig
	}
	return nil
...
func (x *ApplyRequest) GetStringConfig() string {
	if x, ok := x.GetServiceConfig().(*ApplyRequest_StringConfig); ok {
		return x.StringConfig
	}
	return ""
}
...
func (x *ApplyRequest) GetStructConfig() *structpb.Struct {
	if x, ok := x.GetServiceConfig().(*ApplyRequest_StructConfig); ok {
		return x.StructConfig
	}
	return nil
}
...
var file_plugin_comm_proto_goTypes = []interface{}{
...
func file_plugin_comm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_plugin_comm_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plugin_comm_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plugin_comm_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plugin_comm_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plugin_comm_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plugin_comm_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
		...
		file_plugin_comm_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plugin_comm_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_plugin_comm_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartRequest_Config); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_plugin_comm_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*StartRequest_StringConfig)(nil),
		(*StartRequest_StructConfig)(nil),
	}
	file_plugin_comm_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*ApplyRequest_StringConfig)(nil),
		(*ApplyRequest_StructConfig)(nil),
	}
	file_plugin_comm_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}

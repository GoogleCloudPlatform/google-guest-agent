...
import (
	...
	sspb "github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/snapshot/proto/snapshot_service_go_proto"
	sspgrpc "github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/snapshot/proto/snapshot_service_proto_grpc"
...
func (s *snapshotServer) CreateConnection(ready *sspb.GuestReady, stream sspgrpc.SnapshotService_CreateConnectionServer) error {
...
func runServer(ss *snapshotServer, socket string) error {
	...
	sspgrpc.RegisterSnapshotServiceServer(server, ss)

...
import (
	...
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/network/dhclient"
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/network/netplan"
	...
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/network/nm"
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/network/service"
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/network/wicked"
)

...
import (
	...
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/metadatascriptrunner"
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/stages/early"
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/cmd/core_plugin/stages/late"
	...
	"github.com/GoogleCloudPlatform/google-guest-agent/dev/internal/logger"
	...
	pbgrpc "github.com/GoogleCloudPlatform/google-guest-agent/dev/internal/plugin/proto/plugin_comm_proto_grpc"
)
...
func initPluginServer() error {
	...
	pbgrpc.RegisterGuestAgentPluginServer(server, ps)

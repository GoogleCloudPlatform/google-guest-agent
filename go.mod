...
require (
	...
	github.com/GoogleCloudPlatform/agentcommunication_client v0.0.0-20260224214311-6a995384aacc
	github.com/GoogleCloudPlatform/galog v0.0.0-20260330233621-2cc28a700f01
